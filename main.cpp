...
GLuint textura_tira;
GLuint textura_tira2;
GLuint textura_tira3;
GLuint textura_tira4;
...
void click_mouse(int butom, int state, int x,int y)
{
    ...
    if(menu==1)
    {
        printf("5x,y,z %lf,%lf, \n",cordenada_mouse.x,cordenada_mouse.y);
...
void inicializa_textura()
{
    ...
    textura_tira = SOIL_load_OGL_texture
                   (
                       "imagens/linha.png",
                       SOIL_LOAD_AUTO,
                       SOIL_CREATE_NEW_ID,
    ...
    if (textura_tira == 0)
    {
        printf("textura_tira do SOIL: '%s'\n", SOIL_last_result());
    }

    textura_tira2 = SOIL_load_OGL_texture
                    (
                        "imagens/linha2.png",
                        SOIL_LOAD_AUTO,
                        SOIL_CREATE_NEW_ID,
    ...
    textura_tira3 = SOIL_load_OGL_texture
                    (
                        "imagens/linha3.png",
                        SOIL_LOAD_AUTO,
                        SOIL_CREATE_NEW_ID,
    ...
    textura_tira4 = SOIL_load_OGL_texture
                    (
                        "imagens/linha4.png",
                        SOIL_LOAD_AUTO,
                        SOIL_CREATE_NEW_ID,
...
void aplica_texturas()
{
    ...
    glBindTexture(GL_TEXTURE_2D, textura_tira);
    glBegin(GL_QUADS);
    glTexCoord2f(0, 0);
    glVertex3f(-largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,largura_maquina/2-expessura_chapa/2+0.1);
    glTexCoord2f(1, 0);
    glVertex3f(largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,largura_maquina/2-expessura_chapa/2+0.1);
    glTexCoord2f(1, 1);
    glVertex3f(largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-10,largura_maquina/2-expessura_chapa/2+0.1);
    glTexCoord2f(0, 1);
    glVertex3f(-largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-10,largura_maquina/2-expessura_chapa/2+0.1);
    glEnd();
    ...
    glBindTexture(GL_TEXTURE_2D, textura_tira2);
    glBegin(GL_QUADS);
    glTexCoord2f(0, 0);
    glVertex3f(largura_maquina/2+0.1,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,largura_maquina/2-2);
    glTexCoord2f(1, 0);
    glVertex3f(largura_maquina/2+0.1,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,-largura_maquina/2-2);
    glTexCoord2f(1, 1);
    glVertex3f(largura_maquina/2+0.1,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-10,-largura_maquina/2-2);
    glTexCoord2f(0, 1);
    glVertex3f(largura_maquina/2+0.1,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-10,largura_maquina/2-2);
    glEnd();
    ...
    glBindTexture(GL_TEXTURE_2D, textura_tira4);
    glBegin(GL_QUADS);
    glTexCoord2f(0, 0);
    glVertex3f(largura_maquina/2+0.1,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,largura_maquina/2+2);
    glTexCoord2f(1, 0);
    ...
    glBindTexture(GL_TEXTURE_2D, textura_tira3);
    glBegin(GL_QUADS);
    glTexCoord2f(0, 0);
    glVertex3f(-largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,largura_maquina/2+2.1);
    glTexCoord2f(1, 0);
    glVertex3f(largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-20,largura_maquina/2+2.1);
    glTexCoord2f(1, 1);
    glVertex3f(largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-10,largura_maquina/2+2.1);
    glTexCoord2f(0, 1);
    glVertex3f(-largura_maquina/2,altura_maquina/2-largura_chapa-(altura_maquina-2*largura_chapa)-largura_chapa-10,largura_maquina/2+2.1);
    glEnd();
